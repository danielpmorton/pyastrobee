"""Slightly modified version of make_vec_env in stable baselines to allow for specifying input parameters
on a per-environment basis

This function is essentially fully copied from stable baselines except for any lines associated with the new
"per_env_kwargs" input
"""
